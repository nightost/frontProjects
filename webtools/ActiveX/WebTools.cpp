...
USERES("WebTools.res");
USEUNIT("WebTools_ATL.cpp");
USETLB("WebTools.tlb");
USEUNIT("WebTools_TLB.cpp");
USEUNIT("DirectPrinterImpl.cpp"); /* DirectPrinter: CoClass */
USEUNIT("PrinterMgr.cpp");
//---------------------------------------------------------------------------
...
BEGIN_OBJECT_MAP(ObjectMap)
  OBJECT_ENTRY(CLSID_DirectPrinter, TDirectPrinterImpl)
END_OBJECT_MAP()
